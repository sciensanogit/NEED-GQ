...
tbl_mult_var_dicho <- function(data, group_var, vars_match) {
  ...
  df2 |>
    mutate(across(
      starts_with(vars_match),
      ~ if_else(is.na(.x), 0, .x) |> factor(levels = c(0, 1))
      )
    ) |>
    tbl_summary(
      by = {{ group_var }},
...
```{r, tab.id="tbl-burden-trt-time"}
#| tab.cap = "Burden of treatment (HC6) by time since diagnosis"

tbl_one_var_cont(df, time_since_diag, treatment_burden, "Treatment burden")
```

\newpage

```{r, tab.id="tbl-burden-trt-gender"}
#| tab.cap = "Burden of treatment (HC6) by gender"

tbl_one_var_cont(df, gender, treatment_burden, "Treatment burden")
```

\newpage

```{r, tab.id="tbl-burden-trt-education"}
#| tab.cap = "Burden of treatment (HC6) by education"

tbl_one_var_cont(df, education, treatment_burden, "Treatment burden")
```

\newpage

```{r, tab.id="tbl-burden-trt-finance"}
#| tab.cap = "Burden of treatment (HC6) by financial situation"

tbl_one_var_cont(df, finance, treatment_burden, "Treatment burden")
```

\newpage

```{r, tab.id="tbl-burden-trt-diag"}
#| tab.cap = "Burden of treatment (HC6) by diagnosis"

tbl_one_var_cont(df, diagnosis, treatment_burden, "Treatment burden")
```

\newpage

```{r, tab.id="tbl-burden-trt-age"}
#| tab.cap = "Burden of treatment (HC6) by age"

tbl_one_var_cont(df, age, treatment_burden, "Treatment burden")
```
...
```{r, tab.id="tbl-social-support-living"}
#| tab.cap = "Social support needs by living situation"

tbl_mult_var_dicho(df, living_situation, "S7_SQ")
```
...
```{r, tab.id="tbl-impact-personal-relations-living"}
#| tab.cap = "Impact on personal relations by living situation"
...
```{r, tab.id="tbl-impact-education-living"}
#| tab.cap = "Impact on education by living situation"

tbl_one_var_cont(df, living_situation, impact_education, "Impact on education")
```
